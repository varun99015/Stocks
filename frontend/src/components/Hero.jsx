...
const Hero = () => {
    ...
    return (
            <div className="flex flex-col items-center mt-6 lg:mt-20 bg-space-1 bg-cover bg-center bg-no-repeat h-screen min-h-[1000px] ">  
            ...
            />
                    ...
                    <div className="mt-10 flex items-center justify-center gap-x-6">
                        ...
                        <a href="#" className="text-sm font-semibold text-zinc-200">
               ...
               <div className="flex mt-10 mb - 20 justify-center">
                <video autoPlay muted loop className="rounded-lg w-1/3 border border-orange-700 shadow-orange-400 mx-2 my-4">
